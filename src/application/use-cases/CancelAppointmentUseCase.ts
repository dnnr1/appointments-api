...
export class CancelAppointmentUseCase {
  ...
  async execute(input: CancelAppointmentInput): Promise<CancelAppointmentOutput> {
    ...
    await this.cacheProvider.delete(this.userCacheKey(appointment.userId.toString()))
    await this.cacheProvider.delete(this.dateCacheKey(appointment.date.toDate()))
