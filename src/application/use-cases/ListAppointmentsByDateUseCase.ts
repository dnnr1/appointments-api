...
export class ListAppointmentsByDateUseCase {
  ...
  async execute(input: ListAppointmentsByDateInput): Promise<AppointmentOutput[]> {
    ...
    const appointments = await this.appointmentRepository.listByDateRange(start, end)
