...
export const useCases = {
  ...
  cancelAppointment: new CancelAppointmentUseCase(appointmentRepository, dateProvider, cacheProvider),
  rescheduleAppointment: new RescheduleAppointmentUseCase(appointmentRepository, dateProvider, cacheProvider),
  listByUser: new ListAppointmentsByUserUseCase(appointmentRepository, cacheProvider),
  listByDate: new ListAppointmentsByDateUseCase(appointmentRepository, cacheProvider, dateProvider)
}
